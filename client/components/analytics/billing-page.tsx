    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">Billing Analytics</h1>
            <p className="text-sm md:text-base text-muted-foreground">Contractor bills and payment tracking</p>
          </div>
        </div>
